...
alias ls="ls --color=auto -I '\$Recycle.Bin' -I '\$RECYCLE.BIN' -I 'System Volume Information' -I 'Documents and Settings' -I 'hiberfil.sys' -I 'pagefile.sys' -I 'My Music' -I 'My Videos' -I 'My *' -I 'desktop.ini' -I 'NTUSER.DAT' -I 'Application Data' -I 'ntuser*' -I 'NTUSER*' -I '*All\ Users' -I '*Default User' -I 'Local Settings' -I 'Cookies' -I 'SendTo' -I 'NetHood' -I 'Recent' -I 'PrintHood' -I 'Templates' -I '「开始」菜单'"
